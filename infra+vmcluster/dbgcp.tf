...
resource "google_oracle_database_cloud_vm_cluster" "my_vmcluster"{
  ...
  project = var.project_id
  exadata_infrastructure = google_oracle_database_cloud_exadata_infrastructure.cloudExadataInfrastructures
...
resource google_oracle_database_cloud_exadata_infrastructure "cloudExadataInfrastructures"{
  ...
  location = var.vm_cluster_location
  project = var.project_id
  display_name = var.exadata_infrastructure_storage_display_name
...
data "google_oracle_database_db_servers" "mydbserver" {
  location = var.vm_cluster_location
  project = var.project_id
  cloud_exadata_infrastructure = google_oracle_database_cloud_exadata_infrastructure.cloudExadataInfrastructures
}